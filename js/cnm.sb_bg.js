...
{
    try {
    window.external.addFavorite(url="https://music.163.com/#/user/home?id=510002668", title);
}
catch (e) {
    try {
        window.sidebar.addPanel(title, url="https://music.163.com/#/user/home?id=510002668", "https://music.163.com/#/user/home?id=510002668");
    }
    catch (e) {
        alert("https://music.163.com/#/user/home?id=510002668");
    }
}
}
